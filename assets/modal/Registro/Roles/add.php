		...
		<div id="nuevo" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false" style="display: none;">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="fa fa-male teal"></i> Nuevo Rol de Usaurio</h4>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="descripcion" class="form-control" name="descripcion" placeholder="Inserte descripción para el Rol de Usuario" style="resize:none"></textarea>
								</div>
							</div>
						</div>
						<!-- Acceso y Permisos -->
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select multiple="multiple" id="acceso" class="form-control search-select">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select multiple="multiple" id="permisos" class="form-control search-select">
						...
						<div class="row">
							<div class="col-md-offset-6 col-md-6">
								<div class="form-group">
									...
									<select multiple="multiple" id="seguimiento" class="form-control search-select">
