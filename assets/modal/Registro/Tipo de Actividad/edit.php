		<div id="editar" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false" style="display: none;">
			<div class="modal-header">
				...
				<h4 id="modal-title" class="modal-title"><i class="flaticon-graduate6 teal"></i></h4>
			</div>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input id="nombre_e" class="form-control" name="nombre" type="text" placeholder="Inserte nombre para el Tipo de Actividad" >
								</div>
							</div>
							<!-- Abreviatura -->
							<div class="col-md-2">
