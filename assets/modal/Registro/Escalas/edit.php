		<div id="editar" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false" style="display: none;">
			<div class="modal-header">
				...
				<h4 id="modal-title" class="modal-title"> Nueva Escala</h4>
			</div>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input id="nombre_e" class="form-control" name="nombre" type="text" placeholder="Inserte nombre para la escala" >
								</div>
							</div>
							<!-- Abreviatura -->
							<div class="col-md-2">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="descripcion_e" class="form-control" name="descripcion" placeholder="Inserte descripción para la escala" style="resize:none"></textarea>
								</div>
							</div>
						</div>
						<!-- Rango de tiempo -->
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input id="rangotiempo_e" type="text" class="form-control date-time-range">
								</div>
							</div>
						</div>
						<!-- Campos necesarios -->
