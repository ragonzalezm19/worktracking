		...
		<div id="responsive" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false" style="display: none;">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="flaticon-person128 teal"></i> Nueva Actividad</h4>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input id="nombre" class="form-control" name="nombre" type="text" placeholder="Inserte nombre para la actividad" >
								</div>
							</div>
						</div>
						<!-- Descripcion -->
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="descripcion" class="form-control" name="descripcion" placeholder="Inserte descripción para la actividad" style="resize:none"></textarea>
								</div>
							</div>
						</div>
						<!-- Condicion y Escala -->
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select id="condicion" class="form-control search-select" >
										<option value=""></option>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select id="escala" class="form-control search-select" >
										<option value=""></option>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select id="entrega" class="form-control search-select" >
										<option value=""></option>
