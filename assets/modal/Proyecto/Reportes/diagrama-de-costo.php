		...
		<div id="diagrama-de-costo" class="modal fade" tabindex="-1" data-width="1200" data-height="670" data-backdrop="static" data-keyboard="false" style="display: none;">
						...
						<table id="tabla-proyectos" class="table table-striped table-bordered table-hover table-full-width">
							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 50px;">
										<a class="btn btn-primary" href="../../../app/Proyecto/Reportes/Diagrama de Costo/index.php?id=<?php echo $Proyecto['id'] ?>" target="blank_"><i class="flaticon-education14_"></i></a>
									</td>
								</tr>
								<?php else: ?>
