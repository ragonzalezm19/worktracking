		...
		<div id="informacion-de-proyecto" class="modal fade" tabindex="-1" data-width="1200" data-height="670" data-backdrop="static" data-keyboard="false" style="display: none;">
						...
						<table id="tabla-proyectos" class="table table-striped table-bordered table-hover table-full-width">
							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 50px;">
										<a class="btn btn-primary" href="../../../assets/reports/informacion-de-proyecto.php?id=<?php echo $Proyecto['id'] ?>" target="blank_" ><i class="flaticon-dataanalytics1_"></i></a>
									</td>
								</tr>
								<?php else: ?>
