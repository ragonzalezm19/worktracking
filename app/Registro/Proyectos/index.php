...
<html>
	...
	<body>
								...
								<tbody>
									<?php foreach ($allProyectos as $Proyecto): ?>
										<tr>
											...
											<td><?php echo $Proyecto['costo'] ?></td>
											<td><?php echo $Proyecto['c_nombre']?></td>
											<?php if ($Proyecto['estado']): ?>
											...
											<?php if (isset($Usuario_seguimiento)): ?>
											<?php if (in_array("Creado", $Usuario_seguimiento)): ?>
											<td><?php echo $Proyecto['creado'] ?></td>
											<?php endif ?>
											<?php if (in_array("Editado", $Usuario_seguimiento)): ?>
											<td><?php echo $Proyecto['editado'] ?></td>
											<?php endif ?>
										<?php endif ?>
											<?php if ($Editar == 1 || $Eliminar == 1): ?>
											<td style="width: 50px;">
												<div class="btn-group">
													...
													<?php if ($Editar == 1): ?>
														<li role="presentation">
															<a id="editar_<?php echo $Proyecto['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
																Editar
															</a>
														</li>
													<?php endif ?>
													<?php if ($Eliminar == 1): ?>
														<li role="presentation">
															<a id="deshabilitar_<?php echo $Proyecto['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
																Deshabilitar
															</a>
														</li>
													<?php endif ?>
		...
		<?php include $Path.'assets/modal/Registro/Proyectos/add.php' ?>
		<?php include $Path.'assets/modal/Registro/Proyectos/edit.php' ?>
		<?php include $Path.'assets/modal/Registro/Proyectos/status.php' ?>
	</body>
