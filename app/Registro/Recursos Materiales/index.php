<?php 
	...
	$allRecursosMateriales = allRecursosMateriales();
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
					...
					<div class="panel panel-default">
						...
						<?php if ($Leer == 1): ?>
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									<?php foreach($allRecursosMateriales as $RecursoMaterial): ?>
									<tr>
										<td><?php echo $RecursoMaterial['id'] ?></td>
										<td><?php echo $RecursoMaterial['nombre'] ?></td>
										<td><?php echo $RecursoMaterial['abreviatura'] ?></td>
										<td><?php echo $RecursoMaterial['cantidad'] ?></td>
										<?php if ($RecursoMaterial['estado']): ?>
										...
										<?php if (isset($Usuario_seguimiento)): ?>
											<?php if (in_array("Creado", $Usuario_seguimiento)): ?>
											<td><?php echo $RecursoMaterial['creado'] ?></td>
											<?php endif ?>
											<?php if (in_array("Editado", $Usuario_seguimiento)): ?>
											<td><?php echo $RecursoMaterial['editado'] ?></td>
											<?php endif ?>
										<?php endif ?>
										<?php if ($Editar == 1 || $Eliminar == 1): ?>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu" style="min-width: 0px;">
													...
													<li role="presentation">
														<a id="editar_<?php echo $RecursoMaterial['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
													<?php endif ?>
													<?php if ($Eliminar == 1): ?>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $RecursoMaterial['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
													<?php endif ?>
		...
		<?php include $Path.'assets/modal/Registro/Recursos Materiales/add.php' ?>
		<?php include $Path.'assets/modal/Registro/Recursos Materiales/edit.php' ?>
		<?php include $Path.'assets/modal/Registro/Recursos Materiales/status.php' ?>
	</body>
