...
<html>
	...
	<body>
							...
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									...
									<tr>
										...
										<?php if (isset($Usuario_seguimiento)): ?>
											<?php if (in_array("Creado", $Usuario_seguimiento)): ?>
											<td><?php echo $Feriado['creado'] ?></td>
											<?php endif ?>
											<?php if (in_array("Editado", $Usuario_seguimiento)): ?>
											<td><?php echo $Feriado['editado'] ?></td>
											<?php endif ?>
										<?php endif ?>
										<?php if ($Editar == 1 || $Eliminar == 1): ?>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<?php if ($Editar == 1): ?>
													<li role="presentation">
														<a id="editar_<?php echo $Feriado['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
												<?php endif ?>
												<?php if ($Eliminar == 1): ?>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $Feriado['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
												<?php endif ?>
		...
		<?php include $Path.'assets/modal/Registro/Feriados/add.php' ?>
		<?php include $Path.'assets/modal/Registro/Feriados/edit.php' ?>
		<?php include $Path.'assets/modal/Registro/Feriados/status.php' ?>
	</body>
