	...
	<script>
		...
		$('button#agregar').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Parametros/Entregables/add.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){ 
						location.reload();
		...
		$('a[href="#editar"]').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Parametros/Entregables/edit.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
						$('#modal-title').empty().append('<i class="flaticon-user84 teal"></i>');
						$('#nombre_e').val('');
						$('#descripcion_e').val('');
						$('#id-escondido-editar').val('');

						$('#modal-title').append('Entregable No. '+respuesta['id']);
		...
		$('#actualizar').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Parametros/Entregables/update.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
						location.reload();
		...
		$('a[href="#estado"]').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Parametros/Entregables/status.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
		...
		$('button#estado-accion').click(function () 
		{
			...
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Parametros/Entregables/update-status.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
						location.reload();
