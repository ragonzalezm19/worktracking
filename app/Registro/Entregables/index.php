...
<html>
	...
	<body>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									<?php foreach($allEntregables as $Entregable): ?>
									<tr>
										<td><?php echo $Entregable['id'] ?></td>
										<td><?php echo $Entregable['nombre'] ?></td>
										<td><?php echo $Entregable['descripcion'] ?></td>
										<?php if ($Entregable['estado']): ?>
										...
										<?php endif ?>
										<td><?php echo $Entregable['creado'] ?></td>
										<td><?php echo $Entregable['editado'] ?></td>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu" style="min-width: 0px;">
													<li role="presentation">
														<a id="editar_<?php echo $Entregable['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $Entregable['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
												</ul>
		...
		<?php include $Path.'assets/modal/Parametros/Entregables/add.php' ?>
		<?php include $Path.'assets/modal/Parametros/Entregables/edit.php' ?>
		<?php include $Path.'assets/modal/Parametros/Entregables/status.php' ?>
	</body>
