...
<html>
	...
	<body>
				...
				<div class="row">
					<div class="col-sm-12">
						<ol class="breadcrumb">
							...
							<li class="active"> Acividades </li>
						</ol>
						<div class="page-header">
							<h1> Parametros: Acividades </h1>
						</div>
					</div>
				</div>
				<div class="row">
							...
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									...
									<tr>
										...
										<!-- <td><a href="#"><?php echo 'No. '.$Actividad['c_id'] ?></a></td>
										<td><a href="#"><?php echo 'No. '.$Actividad['esc_id'] ?></a></td> -->
										<td><a href="#"><?php echo 'No. '.$Actividad['en_id'] ?></a></td>
										<td><a href="#"><?php echo 'No. '.$Actividad['esp_id'] ?></a></td>
										<td><a href="#"><?php echo 'No. '.$Actividad['cl_id'] ?></a></td>
										<?php if ($Actividad['estado']): ?>
										...
										<?php endif ?>
										<td><?php echo $Actividad['creado'] ?></td>
										<td><?php echo $Actividad['editado'] ?></td>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu" style="min-width: 0px;">
													<li role="presentation">
														<a id="editar_<?php echo $Actividad['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $Actividad['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
												</ul>
		...
		<?php include $Path.'assets/modal/Parametros/Actividades/add.php' ?>
		<?php include $Path.'assets/modal/Parametros/Actividades/edit.php' ?>
		<?php include $Path.'assets/modal/Parametros/Actividades/status.php' ?>
	</body>
