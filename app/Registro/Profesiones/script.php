	...
	<script>
		...
		$('button#agregar').click(function () 
		{
			if (Validacion()){
				parametros:{
					...
					jQuery.ajax({
						data: parametros,
						url: '<?php echo $Path ?>assets/ajax/Registro/Profesiones/add.php',
						type: 'post',
						dataType: 'json',
						success: function(respuesta){ 
							location.reload();
		...
		$('a[href="#editar"]').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Registro/Profesiones/edit.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
						$('#modal-title').empty().append('<i class="flaticon-business61 teal"></i> Profesion No. ' + respuesta['id']);
		...
		$('#actualizar').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Registro/Profesiones/update.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
						location.reload();
		...
		$('a[href="#estado"]').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Registro/Profesiones/status.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
		...
		$('button#estado-accion').click(function () 
		{
			parametros:{
				...
				jQuery.ajax({
					data: parametros,
					url: '<?php echo $Path ?>assets/ajax/Registro/Profesiones/update-status.php',
					type: 'post',
					dataType: 'json',
					success: function(respuesta){
						location.reload();
