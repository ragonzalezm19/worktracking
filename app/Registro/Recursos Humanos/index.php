...
<html>
	...
	<body class="navigation-small">
							...
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $RecursoHumano['nombre'] ?></td>
										<td><?php echo $RecursoHumano['apellido'] ?></td>
										<td><?php echo $RecursoHumano['cedula'] ?></td>
										<td><?php echo $RecursoHumano['correo'] ?></td>
										<td><?php echo $RecursoHumano['p_nombre'] ?></td>
										<!-- <td><?php echo $RecursoHumano['r_descripcion'] ?></td> -->
										<?php if ($RecursoHumano['estado']): ?>
										...
										<?php if (isset($Usuario_seguimiento)): ?>
											<?php if (in_array("Creado", $Usuario_seguimiento)): ?>
											<td><?php echo $RecursoHumano['creado'] ?></td>
											<?php endif ?>
											<?php if (in_array("Editado", $Usuario_seguimiento)): ?>
											<td><?php echo $RecursoHumano['editado'] ?></td>
											<?php endif ?>
										<?php endif ?>
										<?php if ($Editar == 1 || $Eliminar == 1): ?>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<?php if ($Editar == 1): ?>
													<li role="presentation">
														<a id="editar_<?php echo $RecursoHumano['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
												<?php endif ?>
												<?php if ($Eliminar == 1): ?>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $RecursoHumano['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
												<?php endif ?>
		...
		<?php include $Path.'assets/modal/Registro/Recursos Humanos/add.php' ?>
		<?php include $Path.'assets/modal/Registro/Recursos Humanos/edit.php' ?>
		<?php include $Path.'assets/modal/Registro/Recursos Humanos/status.php' ?>
		<?php include $Path.'assets/modal/Registro/Recursos Humanos/change-password.php' ?>
		<?php include $Path.'assets/modal/Registro/Recursos Humanos/change-password-confirm.php' ?>
	</body>
