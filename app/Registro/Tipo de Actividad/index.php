...
<html>
	...
	<body>
							...
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo utf8_encode($Especialidad['nombre']) ?></td>
										<td><?php echo utf8_encode($Especialidad['abreviatura']) ?></td>
										<?php if ($Especialidad['estado']): ?>
										...
										<?php endif ?>
										<td><?php echo $Especialidad['creado'] ?></td>
										<td><?php echo $Especialidad['editado'] ?></td>
										<?php if ($Editar == 1 || $Eliminar == 1): ?>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<?php if ($Editar == 1): ?>
													<li role="presentation">
														<a id="editar_<?php echo $Especialidad['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
												<?php endif ?>
												<?php if ($Eliminar == 1): ?>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $Especialidad['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
												<?php endif ?>
		...
		<?php include $Path.'assets/modal/Registro/Tipo de Actividad/add.php' ?>
		<?php include $Path.'assets/modal/Registro/Tipo de Actividad/edit.php' ?>
		<?php include $Path.'assets/modal/Registro/Tipo de Actividad/status.php' ?>
	</body>
