...
<html>
	...
	<body class="navigation-small">
							...
							<table id="maestros" class="table table-striped table-bordered table-hover table-full-width">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $Escala['nombre'] ?></td>
										<td><?php echo $Escala['descripcion'] ?></td>
										<td><?php echo $Escala['desde'] ?></td>
										<td><?php echo $Escala['hasta'] ?></td>
										<td><?php echo $Escala['abreviatura'] ?></td>
										<?php if ($Escala['estado']): ?>
										...
										<?php endif ?>
										<td><?php echo $Escala['creado'] ?></td>
										<td><?php echo $Escala['editado'] ?></td>
										<td style="width: 50px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu" style="min-width: 0px;">
													<li role="presentation">
														<a id="editar_<?php echo $Escala['id'] ?>" href="#editar" tabindex="-1" role="menuitem" data-toggle="modal">
															Editar
														</a>
													</li>
													<li role="presentation">
														<a id="deshabilitar_<?php echo $Escala['id'] ?>" href="#estado" tabindex="-1" role="menuitem" data-toggle="modal">
															Deshabilitar
														</a>
													</li>
												</ul>
		...
		<?php include $Path.'assets/modal/Parametros/Escalas/add.php' ?>
		<?php include $Path.'assets/modal/Parametros/Escalas/edit.php' ?>
		<?php include $Path.'assets/modal/Parametros/Escalas/status.php' ?>
	</body>
