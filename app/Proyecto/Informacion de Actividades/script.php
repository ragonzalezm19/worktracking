...
<!-- start: SCRIPT -->
	...
	<script>
		$('a[id*=\'gantt_\']').click( function (){
			...
			var dp = new dataProcessor("../../../assets/plugins/DhtmlxGantt_v3.1.1_gpl/data.php");
			gantt.load('../../../assets/plugins/DhtmlxGantt_v3.1.1_gpl/data.php')
			dp.init(gantt);
		});
	</script>
	<!-- end   : Gantt -->
