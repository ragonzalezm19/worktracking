...
<html>
	...
	<body>
								...
								<tbody>
									<?php foreach ($ableProyectos as $Proyecto): ?>
										<tr>
											...
											<td style="width: 50px;">
												<a id="proyecto_<?php echo $Proyecto['gantt_id'] ?>" href="#actividades-del-proyecto" class="btn btn-info" data-toggle="modal">
		...
		<?php include $Path.'assets/modal/Proyecto/Asignacion de Recursos/actividades-del-proyecto.php' ?>
		<?php include $Path.'assets/modal/Proyecto/Asignacion de Recursos/asignacion-de-recurso.php' ?>
		<?php include $Path.'assets/modal/Proyecto/Asignacion de Recursos/lista-de-recursos.php' ?>
		<?php include $Path.'assets/modal/Proyecto/Asignacion de Recursos/editar-asignacion-de-recurso.php' ?>
		<?php include $Path.'assets/modal/Proyecto/Asignacion de Recursos/delete-arm-confirm.php' ?>
		<?php include $Path.'assets/modal/Proyecto/Asignacion de Recursos/delete-arh-confirm.php' ?>
	</body>
